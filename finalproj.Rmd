...
## Project Roadmap
  In particular, we have picked the 5 most representative types of tech companies including Streaming, E-commerce, Entertainment (Gaming), Work-From-Home, and integrated companies, i.e. the giants. In the following pages, we will evaluate the companies' performances mainly based on three measurements. First, we look at the companies' behave on the stock market. Moreover, we introduce the measurement *Confidence Index* to evaluate investor confidence in the market. Finally, we also take the companies' quarterly revenue into account. Based on the three measurements described above, we hope our work would shed some light for those who look back at this unprecedented year.
