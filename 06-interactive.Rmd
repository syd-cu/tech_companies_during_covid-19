...
The interactive plot below allows user to choose any set of stocks they want to compare in one graph. In this way, the user can freely explore all combinations of stock which may take up to $2^{25}$ static graphs to present. All the closing price are scaled so that they all start at 100.
