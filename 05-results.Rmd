...
In the 2nd part, firstly, we created stock line chart that overlays CI bar chart across different tech services provider to explore the potential correlation between investors' stock CI and stock closing price. 

Moreover, Parrallel Coordinates plots were created to explore the potential correlations between Quarterly CI and companies' quarterly revenue. 
```{r}
library(tidyverse)
library(ggplot2)
library(parcoords)
...
### part 2.1:  confidence index and stock closing price(standardized) 
#### Streaming Services
```{r}
...
f2<-p1+ geom_line(aes(Date, Close, color=Index), std_shopping_stock )+
  scale_x_date(date_breaks = "1 month", date_labels = "%m-%d") +
  labs(title="Standardized stock closing price & Standardized CI in 2020(Online shopping)", color="Company")+
  scale_color_manual(values=c("tomato", "violet", "steelblue", "gold", "brown", "black", "seagreen"), 
                       name="") +
  theme_light()+
  theme(plot.title = element_text(hjust = 0.5))
...
f3<-p1+ geom_line(aes(Date, Close, color=Index), std_entertainment_stock   )+
  scale_x_date(date_breaks = "1 month", date_labels = "%m-%d") +
  labs(title="Standardized stock closing price & Standardized CI in 2020 (Entertainment)", color="Company")+
...
f4<-p1+ geom_line(aes(Date, Close, color=Index), std_wfh_stock)+
  scale_x_date(date_breaks = "1 month", date_labels = "%m-%d") +
  labs(title="Standardized stock closing price  Standardized CI in 2020(work from home)", color="Company")+
...
f5<-p1+ geom_line(aes(Date, Close, color=Index), std_other_stock)+
  scale_x_date(date_breaks = "1 month", date_labels = "%m-%d") +
  labs(title="Standardized stock closing price & Standardized CI in 2020 (Other category)", color="Company")+
...
### Part 2.2: Quarterly confidence Index and Quarterly Revenue 
```{r}
...
streaming_p
```
Before COVID-19, there is a positive correlation between investors' confidence level and revenue of streaming companies.  Compared to 1st quarter of 2019, 2nd quarter of 2019's CI increased, and the revenue for streaming companies increased as well.

After COVID-19,there is a negative correlation between investors' confidence level and revenue of streaming companies.  For instance, compared to 2020 2nd quarter's CI,  the 2020 3rd quarter's CI decreased but the revenue of the 3rd quarter across different streaming companies increased.
...
Before COVID-19, compared to CI of 2019 1st quarter , 2nd quarter of 2019's CI increased but the revenue is less than that of the 1st quarter.After COVID-19, for example,  although the CI of 2020 3rd quarter decreased compared with that of 2020 2nd quarter, the revenue of companies like Farfetch, Amazon and Etsy increased as well. 
...
entertainment_p
```
Before COVID-19, there is a positive correlation between investors' confidence level and revenue of streaming companies.  Compared to 4th quarter of 2018, 2nd quarter of 2019's CI increased, and the revenue of two gaming companies increased as well.

After COVID-19,there is a negative correlation between investors' confidence level and revenue of streaming companies.  For instance, compared to 2020 2nd quarter's CI,  the 2020 3rd quarter's CI decreased but the revenue of the 3rd quarter across two gaming companies shown increased.
...
```
Before COVID-19, there is a positive correlation between investors' confidence level and revenue of WFH companies. For example,  Compared to 1st quarter of 2019, 2nd quarter of 2019's CI increased, and the revenue increased as well.

After COVID-19,there is a negative correlation between investors' confidence level and revenue of WFH companies.  For instance, compared to 2020 2nd quarter's CI,  the 2020 3rd quarter's CI decreased but the revenue of the 3rd quarter for two WFH companies increased.
